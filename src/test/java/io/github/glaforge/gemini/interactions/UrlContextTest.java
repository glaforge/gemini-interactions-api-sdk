...
public class UrlContextTest {
    ...
    void testUrlSummarization() throws IOException, InterruptedException {
        ...
        Tool urlContextTool = new Tool.UrlContext();

        // 2. Create Interaction
        // User asked to summarize a specific URL
        String url = "https://fr.wikipedia.org/wiki/Intelligence_artificielle";
        ...
        if (lastOutput instanceof Step.UrlContextResultStep urlResult) {
            ...
            InteractionParams.ModelInteractionParams continuationParams = InteractionParams.ModelInteractionParams
                    .builder()
                    .model("gemini-3.1-flash-lite")
